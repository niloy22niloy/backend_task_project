                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="contact_location" id="textAreaExample1" rows="4"></textarea>
                                @if($errors->has('contact_location'))
                                    <div class="alert alert-danger" role="alert">
                                        {{ $errors->first('contact_location') }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" value="" name="employees" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="" name="industry" class="form-control">
